  ...
  return (
    <div className="rounded-ui border bg-surface2 p-3">
      <div className="mb-2 flex items-center justify-between text-[11px] text-muted">
        <span className="font-semibold text-emerald-700 dark:text-emerald-400">Present</span>
        <span className="font-semibold text-orange-700 dark:text-orange-300">Awakening</span>
      </div>
      <div className="relative">
        ...
        <div className="mb-3 flex flex-wrap items-center gap-2">
          <button
            ...
            className={`rounded-ui border px-2 py-1 text-[11px] ${filters.persona ? "border-orange-400/50 bg-orange-400/15 text-orange-800 dark:text-orange-200" : "border-slate-500/40 text-muted"}`}
          >
            Personality
          </button>
          <button
            ...
            className={`rounded-ui border px-2 py-1 text-[11px] ${filters.knowledge ? "border-sky-400/50 bg-sky-400/15 text-sky-800 dark:text-sky-200" : "border-slate-500/40 text-muted"}`}
          >
            Knowledge
          </button>
          <button
            ...
            className={`rounded-ui border px-2 py-1 text-[11px] ${filters.backup ? "border-lime-400/50 bg-lime-400/15 text-lime-800 dark:text-lime-200" : "border-slate-500/40 text-muted"}`}
          >
            Backups
          </button>
        </div>
      ...
      {selected ? (
        <div className="mt-3 rounded-ui border bg-surface p-3">
          <div className="mb-1 flex items-center justify-between gap-2">
            ...
            <span className="rounded-ui border border-sky-500/40 bg-sky-500/15 px-2 py-0.5 text-[10px] uppercase tracking-wide text-sky-800 dark:text-sky-300">
              {selected.kind}
            </span>
          </div>
            ...
            <div className="mt-3">
              {confirmStepVersion !== selectedVersion ? (
                ...
                <div className="space-y-2 rounded-ui border border-rose-500/40 bg-rose-500/10 p-2">
                  <div className="text-xs font-semibold text-rose-800 dark:text-rose-200">Second confirmation required</div>
                  <div className="text-[11px] text-rose-800/90 dark:text-rose-200/90">
